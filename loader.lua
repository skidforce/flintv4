...
local TARGET_URL  = 'https://raw.githubusercontent.com/skidforce/flintv4/main/games/bedwars.lua'
...
--[[
	Loader console
	--------------
	A fake terminal window that stands in for the executor console while flintv4 boots.
...
local function createConsole()
	...
	-- One flat terminal button, shared by the answer row Ask() builds. Callers stack their own
	...
	-- Everything Ask() puts on the answer row, cleared between prompts. The tooltip
...
-- Executors known not to run flintv4 correctly. Checked before anything is downloaded so
...
-- 'Loading flintv4...'; warn() keeps it in the executor output too.
